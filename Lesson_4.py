...
# argv = (int(first_param) * int(second_param)) + int(third_param)
# print("Имя скрипта: ", script_name)
# print("Выработка в часах: ", first_param)
# print("Cтавка в час: ", second_param)
# print("Премия: ", third_param)
# print("Заработная плата: ", argv)
...
# list_output = [el for el in list_input if list_input.count(el) == 1]
# print(list_output)
...
#     else:
#         break
# #print(argv) если необходимо вывести сгенерированный список
# from itertools import cycle
# a = int(first_param)
# for el in cycle(argv):
#     if a > int(second_param):
#         break
#     print(el)
#     a += 1
